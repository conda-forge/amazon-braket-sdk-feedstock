...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/amazon-braket-sdk-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13915&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/amazon-braket-sdk-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `amazon-braket-sdk` can be installed with:

```
conda install amazon-braket-sdk
```

It is possible to list all of the versions of `amazon-braket-sdk` available on your platform with:
